package gr.compiler.vip.screen.barchartjswidget;
...
@UiController("VIP_BarchartjsWidget")
@UiDescriptor("barchartjs-widget.xml")
@DashboardWidget(name = "BarChartJS")
public class BarchartjsWidget extends ScreenFragment {
    @WindowParam
    @WidgetParam
    ...
    public void onAfterInit(AfterInitEvent event) {
        BarChartJSState state = new BarChartJSState();
        ...
        if (commonTag == null)
        {
            jsonString = getVesselConsumptionData();

            state.dataItems = jsonString;
            state.dataLabel = "Consumption (Mt/Day)";
        }
    ...
    private String getVesselConsumptionData()
    {
        String jsonString = "";
    ...
    private TreeMap<Date, Double> getVesselConsumptionTimeSeries()
    {
        ...
        LocalDateTime today = LocalDateTime.now(ZoneId.systemDefault());
        LocalDateTime beforeDays = today.minusDays(15);
